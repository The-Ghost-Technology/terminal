...
JNIEXPORT void JNICALL Java_com_theghosttechnology_hackdroid_TermExec_sendSignal(JNIEnv *env, jobject clazz,
    jint procId, jint signal)
{
    kill(procId, signal);
}

JNIEXPORT jint JNICALL Java_com_theghosttechnology_hackdroid_TermExec_waitFor(JNIEnv *env, jclass clazz, jint procId) {
    int status;
...
JNIEXPORT jint JNICALL Java_com_theghosttechnology_hackdroid_TermExec_createSubprocessInternal(JNIEnv *env, jclass clazz,
