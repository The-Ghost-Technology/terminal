...
public final class RunScript extends RemoteInterface {
    private static final String ACTION_RUN_SCRIPT = "com.theghosttechnology.hackdroid.RUN_SCRIPT";

    private static final String EXTRA_WINDOW_HANDLE = "com.theghosttechnology.hackdroid.window_handle";
    private static final String EXTRA_INITIAL_COMMAND = "com.theghosttechnology.hackdroid.iInitialCommand";
