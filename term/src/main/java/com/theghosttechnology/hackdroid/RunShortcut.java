...
public final class RunShortcut extends RemoteInterface {
    public static final String ACTION_RUN_SHORTCUT = "com.theghosttechnology.hackdroid.RUN_SHORTCUT";

    public static final String EXTRA_WINDOW_HANDLE = "com.theghosttechnology.hackdroid.window_handle";
    public static final String EXTRA_SHORTCUT_COMMAND = "com.theghosttechnology.hackdroid.iShortcutCommand";
