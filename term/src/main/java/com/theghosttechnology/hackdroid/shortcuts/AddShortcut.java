...
package com.theghosttechnology.hackdroid.shortcuts;
...
import com.theghosttechnology.hackdroid.R;
import com.theghosttechnology.hackdroid.RemoteInterface;
import com.theghosttechnology.hackdroid.RunShortcut;
import com.theghosttechnology.hackdroid.TermDebug;
import com.theghosttechnology.hackdroid.compat.AlertDialogCompat;
import com.theghosttechnology.hackdroid.compat.PRNGFixes;
import com.theghosttechnology.hackdroid.util.ShortcutEncryption;
       ...
       extends    android.app.Activity
{
  ...
  void makeShortcut()
  {
              ...
              new View.OnClickListener()
              {
                public void onClick(View p1)
                {
                  ...
                  File get= (lastPath==null)
                    ...
                    {
                      pickerIntent.setClass(getApplicationContext(), com.theghosttechnology.hackdroid.shortcuts.FSNavigator.class)
    ...
    final ImageView img=new ImageView(context);
                    img.setImageResource(com.theghosttechnology.hackdroid.R.drawable.ic_launcher);
    ...
    )
    {
      ...
      Intent wrapper= new Intent();
             ...
             else
             {
               ...
               , Intent.ShortcutIconResource.fromContext(context, com.theghosttechnology.hackdroid.R.drawable.ic_launcher)
               );
             }
